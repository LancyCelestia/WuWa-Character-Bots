...
def build_shared_conversation_export_provider(
    ...
    enabled = bool(getattr(config, "wuwa_shared_export_enabled", False))
    ...
    return SQLiteSharedConversationExporter(
        ...
        include_private=bool(
            getattr(config, "wuwa_shared_export_include_private", False)
        ),
        max_chars=int(getattr(config, "wuwa_shared_export_max_chars", 200)),
    )
