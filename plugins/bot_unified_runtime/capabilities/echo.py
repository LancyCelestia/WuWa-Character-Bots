...
_PUBLIC_HELP_TOPICS = frozenset(
    {"订阅", "点歌", "表情", "天气", "行情", "占卜", "快报", "维基", "萌娘百科", "历史上的今天", "下载", "昵称", "链接", "Epic", "好感度", "吃什么", "偷表情"}
)
...
_HELP_CATEGORIES = (
    ...
    (
        "子功能",
        {
            ...
            "历史上的今天", "天气", "行情", "占卜", "快报", "维基", "萌娘百科", "昵称", "吃什么", "好感度",
        },
    ),
)
...
_HELP_ENTRIES: list[HelpEntry] = [
        ...
        },
        {
            ...
            "lines": ['发链接: 自动解析信息卡，<url>：B站/抖音/小红书/油管/推特/小黑盒/米游社/森空岛/库街区/Lofter/Pixiv/GitHub/音乐平台链接'],
            "detail": '【链接】平台链接自动解析信息卡\n发链接: 自动解析信息卡，<url>：B站/抖音/小红书/油管/推特/小黑盒/米游社/森空岛/库街区/Lofter/Pixiv/GitHub/音乐平台链接（GitHub 仓库出星标/Fork/简介/README 摘要卡）',
        },
        {
            "topic": '草稿',
        ...
        },
        {
            ...
            "index": '【行情】全球股指：行情 或 美股行情/港股行情/A股行情',
            "title_line": '【行情】全球主要股指行情',
            "lines": [
                '行情: 全球主要指数一览（中国区/亚太/欧美），无参数',
                '美股行情 / 港股行情 / A股行情 / 日经行情: 只看指定市场',
            ],
            "detail": '【行情】全球主要股指行情（东方财富公开数据，5 分钟级）\n行情: 全球主要指数一览\n美股行情/港股行情/A股行情/日经行情: 指定市场',
        },
        {
            "topic": '占卜',
            "aliases": ('占卜', '塔罗', '八字', '算命', '算卦', '起卦'),
            "index": '【占卜】八字排盘/塔罗/金钱卦：占卜 | 塔罗 三张 | 八字 1998年3月2日早上7点',
            "title_line": '【占卜】玄学娱乐三件套',
            "lines": [
                '占卜 / 起卦 / 算卦: 金钱卦六掷成卦（老爻自动化出变卦）',
                '塔罗: 单张指引｜塔罗 三张: 过去/现在/未来牌阵',
                '塔罗 每日一抽: 今日牌，同一天同一人固定不变',
                '八字 / 排盘 1998年3月2日早上7点: 四柱排盘（可只写生日，如「八字 1998年3月2日」）',
            ],
            "detail": '【占卜】玄学娱乐三件套\n占卜: 金钱卦\n塔罗: 单张/三张/每日一抽\n八字 <生日时辰>: 四柱排盘',
        },
        {
            ...
            "index": '【快报】今日快报：快报 或 科技新闻/财经快报/国际新闻',
            "title_line": '【快报】今日新闻快报',
            "lines": [
                '快报: 综合8条（科技/财经/国际混合），无参数',
                '科技新闻 / AI新闻 / 财经快报 / 国际新闻: 指定类目',
            ],
            "detail": '【快报】今日新闻快报（IT之家/少数派/华尔街见闻/BBC中文，10 分钟缓存）\n快报: 综合快报\n科技新闻/AI新闻/财经快报/国际新闻: 指定类目',
        },
    {
        "topic": "邮件",
